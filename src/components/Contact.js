...
const Contact = () => {
  ...
  return (
    <div className="tr__section" id="contact">
      <div className="tr__contact">
        <div className="container">
          <div className="tr__main_title" data-align="center">
          ...
          <div className="tr__map wow fadeInUp" data-wow-duration="1s">
